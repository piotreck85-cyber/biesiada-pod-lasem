...
RECIPES: Dict[str, List[Dict[str, Any]]] = {
    ...
    "set1": [  # Grill podstawowy
        ...
        {"name": "Boczek grillowy", "category": "mieso", "unit": "kg", "qty": 0.08, "price": 32.0},
        {"name": "Kaszanka", "category": "mieso", "unit": "kg", "qty": 0.08, "price": 20.0},
        {"name": "Pieczarki (na grill)", "category": "warzywa", "unit": "kg", "qty": 0.06, "price": 15.0},
        {"name": "Ziemniaki (do grilla)", "category": "warzywa", "unit": "kg", "qty": 0.2, "price": 3.5},
        ...
        {"name": "Przyprawy do grilla", "category": "spozywcze", "unit": "opak", "qty": 0.02, "price": 8.0},
        {"name": "Sól kuchenna", "category": "spozywcze", "unit": "opak", "qty": 0.01, "price": 4.0},
        {"name": "Pieprz mielony", "category": "spozywcze", "unit": "opak", "qty": 0.01, "price": 6.0},
    ...
    "set2": [  # Grill rozszerzony
        ...
        {"name": "Boczek grillowy", "category": "mieso", "unit": "kg", "qty": 0.1, "price": 32.0},
        ...
        {"name": "Pieczarki (na grill)", "category": "warzywa", "unit": "kg", "qty": 0.08, "price": 15.0},
        {"name": "Ziemniaki (do grilla)", "category": "warzywa", "unit": "kg", "qty": 0.2, "price": 3.5},
        {"name": "Ser żółty (do burgera)", "category": "nabial", "unit": "kg", "qty": 0.04, "price": 40.0},
        {"name": "Chleb do grilla", "category": "pieczywo", "unit": "szt", "qty": 0.2, "price": 6.0},
        {"name": "Masło", "category": "nabial", "unit": "kg", "qty": 0.012, "price": 40.0},
        {"name": "Ketchup", "category": "spozywcze", "unit": "opak", "qty": 0.05, "price": 8.0},
        {"name": "Musztarda", "category": "spozywcze", "unit": "opak", "qty": 0.03, "price": 6.0},
        {"name": "Sos czosnkowy", "category": "spozywcze", "unit": "opak", "qty": 0.04, "price": 10.0},
        {"name": "Przyprawy do grilla", "category": "spozywcze", "unit": "opak", "qty": 0.025, "price": 8.0},
        {"name": "Sól kuchenna", "category": "spozywcze", "unit": "opak", "qty": 0.01, "price": 4.0},
        {"name": "Pieprz mielony", "category": "spozywcze", "unit": "opak", "qty": 0.01, "price": 6.0},
        {"name": "Ogórek konserwowy", "category": "warzywa", "unit": "sloik", "qty": 0.05, "price": 8.0},
        {"name": "Cebula", "category": "warzywa", "unit": "kg", "qty": 0.03, "price": 3.0},
    ...
    "set3": [  # Grill premium (+ sałatka grecka)
        ...
        {"name": "Boczek grillowy", "category": "mieso", "unit": "kg", "qty": 0.12, "price": 32.0},
        {"name": "Kaszanka", "category": "mieso", "unit": "kg", "qty": 0.1, "price": 20.0},
        {"name": "Szaszłyki", "category": "mieso", "unit": "szt", "qty": 1.0, "price": 8.0},
        {"name": "Żeberka", "category": "mieso", "unit": "kg", "qty": 0.15, "price": 28.0},
        {"name": "Skrzydełka kurczaka", "category": "mieso", "unit": "kg", "qty": 0.1, "price": 18.0},
        {"name": "Pieczarki (na grill)", "category": "warzywa", "unit": "kg", "qty": 0.1, "price": 15.0},
        {"name": "Ziemniaki (do grilla)", "category": "warzywa", "unit": "kg", "qty": 0.25, "price": 3.5},
        {"name": "Ser żółty (do burgera)", "category": "nabial", "unit": "kg", "qty": 0.05, "price": 40.0},
        {"name": "Chleb do grilla", "category": "pieczywo", "unit": "szt", "qty": 0.2, "price": 6.0},
        {"name": "Masło", "category": "nabial", "unit": "kg", "qty": 0.015, "price": 40.0},
        ...
        {"name": "Przyprawy do grilla", "category": "spozywcze", "unit": "opak", "qty": 0.03, "price": 8.0},
        {"name": "Sól kuchenna", "category": "spozywcze", "unit": "opak", "qty": 0.01, "price": 4.0},
        {"name": "Pieprz mielony", "category": "spozywcze", "unit": "opak", "qty": 0.01, "price": 6.0},
...
FIXED_PER_EVENT: List[Dict[str, Any]] = [
    # Kawa/Herbata bufet — mniejsze imprezy również oczekują
    {"name": "Kawa mielona", "category": "kawa", "unit": "opak", "qty": 1, "price": 25.0},
    {"name": "Herbata (torebki)", "category": "kawa", "unit": "opak", "qty": 1, "price": 12.0},
    {"name": "Cukier", "category": "spozywcze", "unit": "kg", "qty": 1, "price": 5.0},
    {"name": "Mleko UHT", "category": "nabial", "unit": "l", "qty": 3, "price": 5.0},
    {"name": "Śmietanka do kawy", "category": "nabial", "unit": "opak", "qty": 2, "price": 8.0},
    {"name": "Cytryna (do herbaty)", "category": "warzywa", "unit": "szt", "qty": 3, "price": 2.0},
    # Środki i jednorazówki
